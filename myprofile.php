...
?>
	...
	<div class="login-page">
		<div class="container"> 
			...
			<div style="height: 200px;width:504px;background:#999999;margin-left: -41px;"> 
			
		</div><img src="image1/<?php echo $row['image']; ?>" style="margin-left:-30px;height: 80px; width: 79px;border-radius: 50%;"><br><br>
